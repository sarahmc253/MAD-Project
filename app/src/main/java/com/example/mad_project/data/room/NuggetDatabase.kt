...
abstract class NuggetDatabase : RoomDatabase() {

    abstract fun pantryItemDao(): PantryItemDao

    companion object {
        @Volatile
        private var INSTANCE: NuggetDatabase? = null

        fun getInstance(context: Context): NuggetDatabase =
            INSTANCE ?: synchronized(this) {
                Room.databaseBuilder(
                    context.applicationContext,
                    NuggetDatabase::class.java,
                    "nugget_db"
